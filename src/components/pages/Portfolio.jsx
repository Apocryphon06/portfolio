...
function Portfolio() {
  return (
    <div className="p-10 py-20 grid lg:grid-flow-col grid-flow-row gap-5 grid-3 items-center">
      ...
      <div>
        <img
          className="me border p-5 rounded-[90px]"
          width={400}
          src={me}
          alt={me}
        />
      ...
      <div>
        <div className="flex flex-col">
          ...
          <div className=" justify-end text-end">
            ...
            <p className="text-[#0b0b0b] text-[44px]">17</p>
          </div>
        </div>
      </div>
